package org.universe.data.profileSkin
...
import org.universe.data.ProfileSkinDecoded
...
class ProfileSkinTest {
    ...
    inner class TexturesProperty {
        ...
        fun `if properties is empty, throws exception`() {
            val skin =
                ProfileSkin(id = getRandomString(), name = getRandomString(), properties = createRandomProperties())
