...
public interface EntitySupplyStrategy<T : EntitySupplier> {
    ...
    public companion object {
         ...
         */
        public val database: EntitySupplyStrategy<DatabaseEntitySupplier> =
            object : EntitySupplyStrategy<DatabaseEntitySupplier> {

                override fun supply(configuration: SupplierConfiguration): DatabaseEntitySupplier =
                    DatabaseEntitySupplier()
